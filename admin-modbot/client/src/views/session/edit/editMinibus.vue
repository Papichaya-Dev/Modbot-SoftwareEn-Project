      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Do you want to delete this bus : <span>{{details.minibus_no}} ( {{details.starting_point}}-{{details.destination_point}} )</span></p>
          </div>
...
export default {
  ...
  async mounted() {
    ...
    this.tempMinibus = supportRes.data;
  ...
  methods: {
    ...
    async updateRoutes(mnbusID) {
      ...
      const response = await axios.put("api/Minibusroutes/" + mnbusID, newdata);
